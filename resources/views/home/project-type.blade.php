            ...
            <div class="col-sm-6 col-lg-4">
              ...
              <article class="product">
                <div class="product-media">
                  <img class="product-img" src="{{ asset ($project->image)}}" alt="" width="370" height="290">
              
                </div>
                <div class="product-body">
                  <div class="product-title">
                    <h5><a href="{{ route('home.project.details', encrypt($project->id) ) }}" previewlistener="true">{{ $project->title }}</a></h5>
                  </div>
                  <div class="product-meta">
                    <div class="group">
                      <span style="font-size: 16px">
                        <i class="lnr lnr-map-marker"></i>{{ $project->location }},
                    </span>
                    </div>
                    <a class="button button-gray-light-outline" href="{{ route('home.project.details', encrypt($project->id))}}">View details</a>
                  </div>
                </div>
              </article>
            </div>
