                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="nav flex-column nav-pills mb-3" role="tablist">
                                    ...
                                    <a href="{{ route('admin.coreValue.index') }}" class="nav-link ">Core Value</a> <a href="{{ route('admin.settings.aboutUs') }}"  class="nav-link " >About us</a>
                            ...
                            <div class="col-sm-10">
                                <div class="tab-content">
                                    ...
                                    <div  class="tab-pane fade show active" role="tabpanel">
                                        @include('admin.settings.privacyPolicy.privacyPolicy')
                                    </div>
