    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                ...
                <a href="{{route('admin.events.index')}}" class="btn btn-primary rounded light">View Events</a>
            </div>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="compose-content">
                                    <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="">
                                        @csrf
