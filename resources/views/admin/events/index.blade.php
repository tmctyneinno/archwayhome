                                ...
                                <tbody>
                                    @forelse ($events as $index => $event)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-primary " style="margin-right: 5px;" href="{{ route('admin.events.edit', encrypt($event->id)) }}">Edit</a>
                                                    <a class="btn btn-danger" href="{{ route('admin.events.destroy', encrypt($event->id)) }}" onclick="return confirm('Are you sure you want to delete this Event?');">Delete</a>
                                                </div>
