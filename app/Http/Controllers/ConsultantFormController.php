...
class ConsultantFormController extends Controller
{
    ...
    { 
        ...
        $validator = Validator::make($request->all(), [
            ...
            'captcha.captcha' => 'The captcha verification failed. Please reload the captcha and try again.',
        ]);
        ...
        return response()->json(['success' => true, 'successs' => 'Consultant form sent successfully!']);
            ...
            return response()->json(['success' => false, 'errors' => 'An unexpected error occurred.']);
        }
    }
